...
public class Bullet extends DynamicVisualObject {
    ...
    public Bullet(int id, BufferedImage skin, Position position, float life, int accountId, VisualGameModel vgm,
            int playerNumber, Animation deadAnim, Animation spawnAnim, double velocity, double angle) {
