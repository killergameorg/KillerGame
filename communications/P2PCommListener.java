...
/**
 * This interface defines the methods that an object must implement to handle
...
public interface P2PCommListener {
	...
	/**
	 * Called when a connection is lost with the specified IP address. Possibly
	 * ocurred an error in the communication.
	 * 
	 * @param ip The IP address of the new connection.
	 */
